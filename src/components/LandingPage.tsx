        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
          ...
          >
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              Launched in 1999, Terra has revolutionized our understanding of Earth's climate,
              oceans, atmosphere, and ecosystems through cutting-edge satellite technology.
            </p>
          ...
          >
            <div className="max-w-4xl mx-auto p-8 bg-gradient-to-r from-blue-900/20 via-red-900/20 to-blue-900/20 rounded-lg border border-red-600/30">
              <h3 className="text-2xl font-bold mb-4">About the Terra Mission</h3>
              <p className="text-gray-300 leading-relaxed mb-4">
                Terra is the flagship Earth observing satellite of NASA's Earth Observing System (EOS).
                Its five state-of-the-art sensors work together to provide unprecedented data about Earth's
                atmosphere, land, oceans, and the interactions between them.
              </p>
              <p className="text-gray-300 leading-relaxed">
                The data collected by Terra has been instrumental in understanding climate change, tracking
                deforestation, monitoring natural disasters, and advancing our knowledge of Earth's complex systems.
              </p>
            </div>
          </motion.div>
        </div>
